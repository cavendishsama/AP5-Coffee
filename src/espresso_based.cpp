...
void EspressoBased::brew(){
    ...
    std::string none {" --------------------------------------------------- "};
    auto box1 = ftxui::dbox({ftxui::text(none + this->get_name() + none) | ftxui::bgcolor(ftxui::Color::Red) | ftxui::bold | ftxui::center });
    ...
    for (auto& i : this->get_ingredients()) {
        ...
        size_t j{};
        for (double percentage { 0.0f }; percentage <= 1.01f; percentage += 0.005f) {
            j++;
            ...
            if(q.front() == "Cinnamon"){
                auto filling = ftxui::hbox({ 
                    ...
                    ftxui::text(" " + String_percent) | ftxui::color(ftxui::Color::RGB(123, 63, 0)) 
                }); 
                ...
                auto filling = ftxui::dbox({ 
                        ...
                        ftxui::text(" " + String_percent) | ftxui::color(ftxui::Color::RGB(92, 51, 23))
                });
                Render(screen, filling);
                std::cout << reset_position;
                screen.Print();
                ...
                auto filling = ftxui::hbox({ 
                    ...
                    ftxui::text(" " + String_percent) | ftxui::color(ftxui::Color::RGB(244, 238, 232))
                });
                Render(screen, filling);
                std::cout << reset_position;
                screen.Print();
                ...
                auto filling = ftxui::hbox({ 
                    ...
                    ftxui::text(" " + String_percent) | ftxui::color(ftxui::Color::RGB(157, 126, 103))
                });
                Render(screen, filling);
                std::cout << reset_position;
                screen.Print();
                ...
                auto filling = ftxui::hbox({ 
                    ...
                    ftxui::text(" " + String_percent) | ftxui::color(ftxui::Color::RGB(60, 34, 24))
                });
                Render(screen, filling);
                std::cout << reset_position;
                screen.Print();
                ...
                auto filling = ftxui::hbox({ 
                    ...
                    ftxui::text(" " + String_percent) | ftxui::color(ftxui::Color::RGB(255, 255, 255))
                });
                Render(screen, filling);
                std::cout << reset_position;
                screen.Print();
                ...
                auto filling = ftxui::hbox({ 
                    ...
                    ftxui::text(" " + String_percent) | ftxui::color(ftxui::Color::RGB(219, 168, 88))
                });
                Render(screen, filling);
                std::cout << reset_position;
                screen.Print();
                ...
                auto filling = ftxui::hbox({ 
                    ...
                    ftxui::text(" " + String_percent) | ftxui::color(ftxui::Color::RGB(128, 197, 222)) 
                });
                Render(screen, filling);
                std::cout << reset_position;
                screen.Print();
